...
type VersionConfig struct {
	...
	// SunsetTime indicates when the version will be removed. When set, the
	// `Sunset` response header is emitted as an HTTP-date.
...
func (cfg VersionConfig) normalizedSunsetHeaderValue() string {
	...
	return cfg.SunsetTime.UTC().Format(http.TimeFormat)
}
